# 1 "../working_lamp.X/src/sensors/humidity.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../working_lamp.X/src/sensors/humidity.c" 2
# 1 "../working_lamp.X/src/sensors/humidity.h" 1



# 1 "../working_lamp.X/src/sensors/../adc/adc.h" 1
...
# 4 "../working_lamp.X/src/sensors/../adc/adc.h" 2
...
# 4 "../working_lamp.X/src/sensors/humidity.h" 2
...
float read_humidity_channel()
{
    ...
    return ((float)adc_value - 0.826)/0.0315;
}
