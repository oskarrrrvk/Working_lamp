# 1 "../working_lamp.X/src/protocols/UART/uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../working_lamp.X/src/protocols/UART/uart.c" 2
...
# 4 "../working_lamp.X/src/protocols/UART/uart.h" 2
...
# 5 "../working_lamp.X/src/protocols/UART/uart.h" 2
