# 1 "../working_lamp.X/src/actuators/leds.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../working_lamp.X/src/actuators/leds.c" 2
# 1 "../working_lamp.X/src/actuators/leds.h" 1



# 1 "../working_lamp.X/src/actuators/../protocols/SPI/spi-master-v1.h" 1
# 11 "../working_lamp.X/src/actuators/../protocols/SPI/spi-master-v1.h"
...
# 12 "../working_lamp.X/src/actuators/../protocols/SPI/spi-master-v1.h" 2
