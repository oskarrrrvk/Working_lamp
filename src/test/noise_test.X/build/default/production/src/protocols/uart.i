...
# 2 "<built-in>" 2
# 1 "src/protocols/uart.c" 2
# 1 "src/protocols/uart.h" 1
...
# 6 "src/protocols/uart.h" 2


void config_uart (void);
void send_noise_to_uart (uint16_t);
...
void send_noise_to_uart (uint16_t value)
{
    printf("noise value: [%i] \r\n",value);
}
