...
static void dtoa(FILE *fp, vfpf_sint_t d)
{
 ...
 int p;
    ...
    s = d < 0 ? 1 : 0;
# 533 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    p = (0 <= prec) ? prec : 1;
...
# 552 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 1) && (d != 0
...
static void efgtoa(FILE *fp, long double f, char c)
{
 ...
 mode = c;
    ...
    nmode = mode;
# 695 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
 {
        p = (prec < 0) ? 6 : prec;
    }
# 711 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    m = p;
 ...
 ne = e;
    ...
    while ((i < m) && (n < (80 - 5))) {
        l = floorf(h/u.f);
        d = (int)l > 9 ? 9 : (int)l;
# 792 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  {
            if (!pp && (ne < 0)) {
                dbuf[n++] = '.';
                --w;
 ...
 i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
# 848 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
 memcpy(&dbuf[i-n], &dbuf[0], (size_t)n);
 n = i-n;
 i = sign == 0 ? 0 : 1;
# 861 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
 if (sign) {
  dbuf[--n] = sign;
 }
 w -= i;
...
# 942 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
static void stoa(FILE *fp, char *s)
{
 ...
 if (!(prec < 0) && (prec < l)) {
  l = prec;
    ...
    p = l;
# 979 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    while (p--) {
        fputc(*cp, fp);
        ++cp;
    }
# 997 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
}
# 1157 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
static int
...
# 1201 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1265 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
        if ((*fmt)[0] == '.') {
            ++*fmt;
...
# 1404 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   ...
   *fmt = cp+1;
# 1432 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   return (void) dtoa(fp, convarg.sint);

  }
# 1656 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  done = 0;
  if ((*fmt)[0] == 's') {
   ++*fmt;
   done = 1;
  ...
  if (done) {
# 1682 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  ...
  switch(c) {
   ...
   case 'L':
    cp++;
    break;
# 1710 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   case 'f':
# 1721 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    c = 'l';
    break;
   default:
    c = 0;
  ...
  if (0
# 1742 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    || *cp == 'f'
# 1753 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    ) {
   switch (c) {
    case 'l':
   ...
   *fmt = cp+1;
   switch (*cp) {
# 1779 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    case 'f':
# 1790 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
